...
wget https://github.com/IntelRealSense/librealsense.git
cd ./librealsense
...
cmake ../ -DBUILD_EXAMPLES=true -DBUILD_GRAPHICAL_EXAMPLES=false -DBUILD_PYTHON_BINDINGS=true -DBUILD_SHARED_LIBS=false -DPYTHON_EXECUTABLE=/usr/bin/python3 -DBUILD_NETWORK_DEVICE=ON -DFORCE_RSUSB_BACKEND=ON -DCMAKE_BUILD_TYPE=Release BUILD_PYTHON_DOCS